...
SECRET_KEY = 'django-insecure-jj%bp2gj)bq1$ys@!f8^yr7h7st+pg(k%%!_lg+m@ha!y*ls^g'
...
TEMPLATES = [
    {
        ...
        'DIRS': [ROOT_TEMPLATE, ORS_TEMPLATE],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'sndpvrma95@gmail.com'
EMAIL_HOST_PASSWORD = 'yenq njuj woxs ihwu'
